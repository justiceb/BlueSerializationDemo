...
<Project Type="Project" LVVersion="20008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Test" Type="Folder">
			<Item Name="Sports" Type="Folder">
				<Item Name="Sports Equipment" Type="Folder">
					<Item Name="Golf Club.lvclass" Type="LVClass" URL="../Test/Sports/Classes/Golf Club.lvclass"/>
				</Item>
				<Item Name="Sports Player Classes" Type="Folder">
					<Item Name="Adam Sandler.lvclass" Type="LVClass" URL="../Test/Sports/Classes/Adam Sandler/Adam Sandler.lvclass"/>
					<Item Name="Basketball Player.lvclass" Type="LVClass" URL="../Test/Sports/Classes/Basketball Player/Basketball Player.lvclass"/>
					<Item Name="Bill Murray.lvclass" Type="LVClass" URL="../Test/Sports/Classes/Bill Murray/Bill Murray.lvclass"/>
					<Item Name="Bobby Jones.lvclass" Type="LVClass" URL="../Test/Sports/Classes/Bobby Jones/Bobby Jones.lvclass"/>
					<Item Name="Chevy Chase.lvclass" Type="LVClass" URL="../Test/Sports/Classes/Chevy Chase/Chevy Chase.lvclass"/>
					<Item Name="Golf Player.lvclass" Type="LVClass" URL="../Test/Sports/Classes/Golf Player/Golf Player.lvclass"/>
					<Item Name="Hulk Hogan.lvclass" Type="LVClass" URL="../Test/Sports/Classes/Hulk Hogan/Hulk Hogan.lvclass"/>
					<Item Name="Human.lvclass" Type="LVClass" URL="../Test/Sports/Classes/Human/Human.lvclass"/>
					<Item Name="John Cena.lvclass" Type="LVClass" URL="../Test/Sports/Classes/John Cena/John Cena.lvclass"/>
					<Item Name="Kareem Abdul-Jabbar.lvclass" Type="LVClass" URL="../Test/Sports/Classes/Kareem Abdul-Jabbar/Kareem Abdul-Jabbar.lvclass"/>
					<Item Name="Kobe Bryant.lvclass" Type="LVClass" URL="../Test/Sports/Classes/Kobe Bryant/Kobe Bryant.lvclass"/>
					<Item Name="Michael Jordan.lvclass" Type="LVClass" URL="../Test/Sports/Classes/Michael Jordan/Michael Jordan.lvclass"/>
					<Item Name="NonBlueSerializable.lvclass" Type="LVClass" URL="../Test/Sports/Classes/NonBlueSerializable/NonBlueSerializable.lvclass"/>
					<Item Name="Pele.lvclass" Type="LVClass" URL="../Test/Sports/Classes/Pele/Pele.lvclass"/>
					<Item Name="Shaquille O&apos;Neal.lvclass" Type="LVClass" URL="../Test/Sports/Classes/Shaquille ONeal/Shaquille O&apos;Neal.lvclass"/>
					<Item Name="Soccer Player.lvclass" Type="LVClass" URL="../Test/Sports/Classes/Soccer Player/Soccer Player.lvclass"/>
					<Item Name="Sports Player.lvclass" Type="LVClass" URL="../Test/Sports/Classes/Sports Player/Sports Player.lvclass"/>
					<Item Name="The Waterboy.lvclass" Type="LVClass" URL="../Test/Sports/Classes/The Waterboy/The Waterboy.lvclass"/>
					<Item Name="Tiger Woods.lvclass" Type="LVClass" URL="../Test/Sports/Classes/Tiger Woods/Tiger Woods.lvclass"/>
					<Item Name="WWE Wrestler.lvclass" Type="LVClass" URL="../Test/Sports/Classes/WWF Westler/WWE Wrestler.lvclass"/>
				</Item>
				<Item Name="Unit Tests" Type="Folder">
					<Item Name="Sports Unit Tests.lvclass" Type="LVClass" URL="../Test/Sports/Unit Tests/Sports Unit Tests.lvclass"/>
				</Item>
			</Item>
		</Item>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="user.lib" Type="Folder">
				...
				<Item Name="BlueJSONTextSerializer.lvlib" Type="Library" URL="/&lt;userlib&gt;/Blue Origin/BlueJSONTextSerializer/BlueJSONTextSerializer.lvlib"/>
				<Item Name="BlueSerialization.lvlib" Type="Library" URL="/&lt;userlib&gt;/Blue Origin/BlueSerialization/BlueSerialization.lvlib"/>
				<Item Name="BlueTOMLSerializer.lvlib" Type="Library" URL="/&lt;userlib&gt;/Blue Origin/BlueTOMLSerializer/BlueTOMLSerializer.lvlib"/>
